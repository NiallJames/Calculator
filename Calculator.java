...
public class Calculator implements ActionListener {
    ...
    Calculator() {
        ...
        textField.setBounds(50, 25, 325, 50);
        ...
        for (int i = 0; i < 9; i++) {
            ...
            functionButtons[i].setBackground(Color.MAGENTA);
